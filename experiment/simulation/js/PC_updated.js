...
function Invpend_PD(){
	...
	var rhs_pol12 = math.multiply(0.001,3.957,math.add(math.multiply(dconst2,math.pow(pol12,2)),math.multiply(pconst2,pol12),iconst2));
	var rhs_pol22 = math.multiply(0.001,3.957,math.add(math.multiply(dconst2,math.pow(pol22,2)),math.multiply(pconst2,pol22),iconst2));
	var rhs_pol32 = math.multiply(0.001,3.957,math.add(math.multiply(dconst2,math.pow(pol32,2)),math.multiply(pconst2,pol32),iconst2));
	...
	yip[t] = (math.add(part12,part22,part32,part42)).re;///0.001 approx;///crane angle
	console.log("cart position="+ yop[t]);
